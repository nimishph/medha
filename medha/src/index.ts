 ...
 *
 * The read plane (§6.1) and write plane (§6.2) land on top of the medha-core kernel (Loom-ujs3.3)
 * and medha-store (Loom-ujs3.4); the maintenance plane (§6.4: session-start sweep, compaction,
